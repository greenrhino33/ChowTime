 ...
 */
public class CropRasberry extends BlockCrops{
...
//        this.setBlockTextureName(ModConstants.MODID + ":barley");
    ...
    {
        return meta == 7 ? CTInits.Rasberry : CTInits.RasberrySeeds;
    }

    @Override
    protected Item func_149866_i()
    {
        return CTInits.RasberrySeeds;
    }
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            this.icons[i] = icon.registerIcon(ModConstants.MODID + ":" + "rasberry_stage_" + i);
        }
    }
