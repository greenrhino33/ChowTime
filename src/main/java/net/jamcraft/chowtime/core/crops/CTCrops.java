...
public class CTCrops extends BlockCrops{
    ...
    private IIcon[] icons;
    private Item seed, drop;
    String name;

    public CTCrops(String name, Item seed, Item drop)
    {
        super();
        float f = 0.5F;
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            this.icons[i] = icon.registerIcon(ModConstants.MODID + ":" + name + "_stage_" + i);
        }
    }
